...
2. Add the repository: `https://package-processor.kittyn.cat/index.json`
3. Find "cátte — Package Processor" in the package list and click "Add"

### Manual Installation
1. Download the latest release from [Releases](https://github.com/kittynXR/package-processor/releases)
2. Extract the zip file to your Unity project's `Packages` folder

## Documentation

See the [package README](kittyncat_tools/cat.kittyn.packageprocessor/README.md) for detailed usage instructions.
...
- [VPM Repository](https://package-processor.kittyn.cat/index.json)
- [GitHub Releases](https://github.com/kittynXR/package-processor/releases)
