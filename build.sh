...
# Configuration
PACKAGE_NAME="cat.kittyn.packageprocessor"
ROOT_DIR="cat.kittyn.packageprocessor"
REPO_OWNER="kittynXR"
REPO_NAME="package-processor"
...
3. Find \"cátte — Package Processor\" and click \"Add\"

### Manual Installation
Download \`$ZIP_FILE\` and extract to your Unity project's \`Packages\` folder."

gh release create "$TAG" \
    --title "cátte — Package Processor $NEW_VERSION" \
    --notes "$RELEASE_NOTES" \
    "$ZIP_FILE"
